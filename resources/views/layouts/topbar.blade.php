        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    <img src="/landingpage/custom_images/logo.png" alt="homepage" class="dark-logo" />
                    <!-- Light Logo icon -->
                    <img src="/landingpage/custom_images/mini-icon.png" alt="homepage" class="light-logo" />
                </b>
                <!--End Logo icon -->
                </span>
            </a>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="/monster_admin/assets/images/users/1.jpg" alt="user" class="profile-pic" />
                    </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
